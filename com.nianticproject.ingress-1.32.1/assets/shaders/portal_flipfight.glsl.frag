...
uniform sampler2D u_fightTexture;
void main() {
 vec4 baseColor = computePortalColor(u_texture, v_texCoord0.xy, u_rampTarget);
 vec4 fightColor = computePortalColor(u_fightTexture, v_texCoord0.xy, u_rampTarget);
